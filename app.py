...
st.markdown("""
    <style>
    body {
        background: linear-gradient(to right, #1f005c, #5b2a86);
        color: white;
...
with st.expander("📅 Suivi des contrôles de qualité"):
    ...
    if intervenants:
        ...
        type_cq = st.selectbox("Type de contrôle", ["Journalier: Résolution", "Hebdomadaire: Stabilisé", "Mensuel: Linéarité", "Annuel: Complèt"])
...
with st.expander("📂 Gestion documentaire"):
    ...
    fichier = st.file_uploader("Téléverser un fichier")
